...
rfcp vocms15.cern.ch:/data/dballest/logCollectionCASTORRecovery/AssembleTarball.py .
rfcp vocms15.cern.ch:/data/dballest/logCollectionCASTORRecovery/runCatalogs-MONTH/REPLACEME .

python2.6 AssembleTarball.py RUNNUMBER MONTH

rfcp REPLACEME.done vocms15.cern.ch:/data/dballest/logCollectionCASTORRecovery/runCatalogs-MONTH/REPLACEME.done
